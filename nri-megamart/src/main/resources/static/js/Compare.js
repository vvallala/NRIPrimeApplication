(function ($) {
    ...
    $(document).on('click', '.addToCompare', function () {
        ...
        if (inArray < 0) {
            ...
            if (list.length < 4) {
                ...
                $(".comparePan").append('<div id="' + productID + '" class="relPos titleMargin w3-col l2 m4 s4"><div class="w3-white titleMargin"><a class="selectedItemCloseBtn w3-closebtn cursor">&times</a><img src="' + image + '" alt="image" style="height:60px;"/><p id="' + productID + '" class="titleMargin1">' + displayTitle + '</p></div></div>');
            }
        } else {
    ...
    $(document).on('click', '.cmprBtn', function () {
        if ($(".cmprBtn").hasClass("active")) {
          ...
          //  $(".contentPop").append('<div class="w3-col s3 m3 compareItemParent relPos">' + '<ul class="product">' + '<li class=" relPos compHeader"><p class="w3-display-middle">Features</p></li>' + '<li>Title</li>' + '<li>Size</li>' + '<li>Weight</li>' + '<li class="cpu">Processor</li>' + '<li>Battery</li></ul>' + '</div>');
