...
<![endif]-->
    ...
    <link href="css/jquery.wm-gridfolio-1.0.css" rel="stylesheet" type="text/css" />
    <script src="js/jquery.wm-gridfolio-1.0.js" type="text/javascript"></script>

    <script src="js/jquery.hover3d.js" type="text/javascript"></script>
...
<span class="wishlst">0</span>-->
        ...
        <div class="enquiry-wrkarea">
            <div class="container enquiries-container">

                <div class="block-head enquiry-head group_site_heading">
                    <h2>Group Sites</h2>
                    <p>For Customized requirements, Please chose the relevant form and send an inquiry to us and we will respond
                        to help</p>
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Megamart</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/MegaMart.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime Tickets</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/Airline Ticket.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime Couriers</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>
                ...
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime GiftsMart</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/Giftsmart.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Global Fashions</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>
                    <img src="images/Global Fashion.png" alt="" />

                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Gold Jewellery</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/GoldJewellery.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime IT Solutions</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/IT Support.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime Insurance</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>
                ...
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Temples</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/Nri Temples.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Now</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/NriNow.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/NriPrime_grp.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Prime Foundation</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/PrimeFoundation.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">Print Pal</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>

                    <img src="images/PrintPal.png" alt="" />
                </div>
                <div class="main col-md-3 snake">
                    <div class="overlay_grp">
                        <span class="title">NRI Print Smart</span>
                        <span class="grp_description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce maximus bibendum mollis.</span>
                        <a href="megamart.html" class="btn login-btn grp_btn">Go to Site</a>
                    </div>
