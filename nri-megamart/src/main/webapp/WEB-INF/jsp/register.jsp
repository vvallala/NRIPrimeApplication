...
<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0css/font-awesome.min.css" rel="stylesheet" type="textcss" />
<!-------------bootstrap-------------------------------->

<!-------------bootstrap-------------------------------->
<link href="css/megamart.css" rel="stylesheet" type="textcss"/>

<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7js/bootstrap.min.js"></script>
<link href="css/bootstrap.css" type="textcss" rel="stylesheet" />
<link href="css/bootstrap-theme.css" type="textcss" rel="stylesheet" />
<link href="css/style.css" type="textcss" rel="stylesheet" />
<script src=js/script.js" type="text/javascript"></script>
<link href="css/prime.css" rel="stylesheet" type="textcss"/>

<script src=js/jquery.contact-buttons.js" type="text/javascript"></script>
<link href="css/contact-buttons.css" rel="stylesheet" type="textcss"/>
<script src=js/jquery.slimscroll.js"></script>
  <!----calender----->
  
<script src=js/calenstyle.js" type="text/javascript"></script>
  <link href="css/calenstyle-iconfont.css" rel="stylesheet" type="textcss"/>
  <link href="css/calenstyle-jquery-ui-override.css" rel="stylesheet" type="textcss"/>
  <link href="css/calenstyle.css" rel="stylesheet" type="textcss"/>
  <script src=js/jquery-ui-custom-1.11.2.min.js" type="text/javascript"></script>
  <link href="css/jquery-ui-custom-1.11.2.min.css" rel="stylesheet" type="textcss"/>
  <link href="css/CalEventList.css" rel="stylesheet" type="textcss"/>
...
<div class="container">
    ...
    <input class="form-control" id="title" type="text">
                       ...
                       <div class="form-group">
                           <label for="f-name" class="sign-name">E Mail <span class="sign-email">(Your email address will facilitate us to communicate with you in future.)</span></label>
    ...
    <input class="form-control" id="title" type="text">
                       ...
                       <div class="form-group">
                           <textarea class="form-control sign-control" placeholder="Please write about yourself which can be used as your 
public profile description in Blog Page"></textarea>
  </div>   
                       <div class="form-group">
    <label for="f-name" class="sign-name">Make Your Profile As</label>
    <input name="a" type="radio"> <span class="sign-radio"> Public</span>
    <input name="a" type="radio"> <span class="sign-radio">Private</span>
  </div>   
                       <div class="form-group">
    <label for="f-name" class="sign-name">Please Check If You Are</label>
    <div class="sign-checkbx"><input name="a" type="Checkbox"> <span class="sign-check"> NRI Students</span></div>
    <div class="sign-checkbx"><input name="a" type="Checkbox"> <span class="sign-check"> Intrested in NRI Prime </span></div>
      <div class="sign-checkbx"><input name="a" type="Checkbox"> <span class="sign-check"> SR Citizens</span></div>
  </div>     
                      <div class="form-group">
                          <span class="captcha-txt">Enter Capcha</span>
    <input class="form-control captcha-dta" id="title" type="text">
    <img src="images/captcha.png" class="captcha">
  </div>   
                      <div class="form-group">
                          <button type="button" class="btn post-btn" data-toggle="modal" data-target="#successalert">Submit</button>
                          <button type="button" class="btn post-btn cancel-btn">Cancel</button>
  </div>  
                      <div class="form-group">
                          <span class="terms">By clicking Submit , you agree to the<a href="termsconditions.html"> Terms and Conditions</a> of this website.</span>
  </div> 
    </div>
    </div>
</div>
