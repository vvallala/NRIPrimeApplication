...
<div class="container blg-container">
    <div class="testi_wrkarea">
<div class="profile-det addr-wrkarea">
       
        <h2 class="test-heading">My Wishlist</h2>
        
            <div class="share_wish">
                      <a href="" data-toggle="modal" data-target="#wishmodel" class="addaddr_txt">Share my wishlist <i class="fa btn_arow fa-angle-right"></i></a>
              ...
              <div class="wish_wrkarea"> 
                  ...
                  <div class="col-xs-12 col-sm-6">
                      <div class="wish_content">
                              ...
                              <div class="wish_bdy">
                                    <input type="checkbox" class="slect_share">
                                  <h6>Roses</h6>
                                  <ul class="wish_stars">
                                      <li><img src="images/testimonials/rating_03.png" alt=""/></li>
                                     <li><img src="images/testimonials/rating_03.png" alt=""/></li>
                                      <li><img src="images/testimonials/rating_03.png" alt=""/></li>
                                      <li><img src="images/testimonials/rating_03.png" alt=""/></li>
                                      <li><img src="images/testimonials/rating_03.png" alt=""/></li>
                                      <li><img src="images/testimonials/rating_05.png" alt=""/></li>
                                  </ul>
                                  <p>INR 540</p>
                                  <button type="button" class="btn teti_btn">Buy Now</button>
                              </div>
                      </div>
                  </div>
                     <div class="col-xs-12 col-sm-6">
      ...
      <div class="modal-content large_mdel_cntent">
        ...
        <div class="modal-body currency-body large_mdel_body">
            <ul class="usr-testi test_del_status">
                      ...
                      <li><b>On Time :</b><span>Yes</span></li>  
                  
                     <li><b>Intact : </b><span>Yes</span></li> 
                   
                      <li><b>Courtesy : </b><span>Yes</span></li> 
