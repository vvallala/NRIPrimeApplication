...
<body>
	<div class="modal fade" id="advertiseenquiry" role="dialog">
		<div class="modal-dialog large_mdel">
			<!-- Modal content-->
			<div class="modal-content large_mdel_cntent">
				<form action="/nriprime/enquiry/advertisement" method="post" name="advertiseenquiry">
					<button type="button" class="close popup_close"
						data-dismiss="modal">
						<img src="images/close.png">
					</button>
					<div class="modal-body large_mdel_body">
						<p class="popup_heading general_padding">Advertisement Enquiry</p>
						<div class="row">
							<div class="col-xs-12 col-sm-8" style="margin-top: 3px;">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<div class="spec_instruc">
												...
												<textarea name="name" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<div class="spec_instruc">
												...
												<textarea name="natureOfBiz" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<p>Advertise</p>
											<select name="advertiseAt" class="courier_enquiry" onchange="gender(this);">
												<option>Advertise at</option>
												<option>NRI Megamart</option>
												<option>Blog</option>
											</select>
										</div>
									</div>
								...
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6 ">
										<div class="general_inche">
											...
											<input name="pickUpDate" value="31-05-2018" class="cart_date_pick"
												type="date">
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 ">
								...
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<p>Design</p>
											<select name="desingHelp" class="courier_enquiry" onchange="gender(this);">
					...
					<pre id="advertiseenquiry_result"></pre>
				</form>
			</div>
		</div>
	</div>
