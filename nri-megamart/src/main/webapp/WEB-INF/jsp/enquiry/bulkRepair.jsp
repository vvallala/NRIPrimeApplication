	...
	<div class="modal fade" id="bulkorder" role="dialog">
		<div class="modal-dialog large_mdel">
			...
			<div class="modal-content large_mdel_cntent">
				<form action="/nriprime/enquiry/bulkProduct" method="post" name="bulkproduct">
							...
							<div class="col-xs-12 col-sm-8" style="margin-top: 3px;">
								...
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-12">
										<div class="tailor_group">
											<input class="form-control contact_prsn_name margin_auto"
												type="text" placeholder="Details of product">
										</div>
									</div>
								</div>
