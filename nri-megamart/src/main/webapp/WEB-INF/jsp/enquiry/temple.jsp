                ...
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/temple" method="post" name="printenquiry">
						...
						<div class="modal-body large_mdel_body">
								...
								<div class="col-xs-12 col-sm-8" style="margin-top:3px;">
									<div class="tailor_group tailor_padding">
										...
										<div class="col-xs-12 col-sm-6">
											<div class="general_inche">
											<p>Country</p>
												<select name="country" class="countries" id="countryId" onchange="gender(this);">
										...
										<div class="col-xs-12 col-sm-6">
											...
											<p>Enquiry Type</p>
												<select name="type" class="courier_enquiry" onchange="gender(this);">
													<option></option>
													<option>Alaya Vastralu</option>
													<option>Gold Jewellry</option>
												</select>
											</div>
										</div> 
										<div class="col-xs-12 col-sm-6">
							...
							<pre id="templeenquiry_result"></pre>
					</form>					
		        </div>
		    </div>
		</div>	
