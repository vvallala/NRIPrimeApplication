...
<body>
	<div class="modal fade" id="secondenquiry" role="dialog">
		<div class="modal-dialog large_mdel">
			<!-- Modal content-->
			<div class="modal-content large_mdel_cntent">
				<form action="/nriprime/enquiry/secondOpinion" method="post" name="secondenquiry">
					<button type="button" class="close popup_close"
						data-dismiss="modal">
						<img src="images/close.png">
					</button>
					<div class="modal-body large_mdel_body">
						<p class="popup_heading general_padding">Second Opinion
							Enquiry</p>
						<div class="row">
							<div class="col-xs-12 col-sm-8" style="margin-top: 3px;">
								<div class="tailor_padding"></div>
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6 ">
										<div class="general_inche">
											<div class="spec_instruc">
												<span>Health Problem Description</span>
												<textarea name="problem" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-sm-6 ">
										<div class="general_inche">
											<div class="spec_instruc">
												<span>Previous Consultation Details</span>
												<textarea name="previousDetails" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<select name="department" class="courier_enquiry" onchange="gender(this);">
												<option>Medical Departments</option>
											</select>
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<select name="doctor" class="courier_enquiry" onchange="gender(this);">
					...
					<pre id="secondenquiry_result"></pre>
				</form>
			</div>
		</div>
	</div>
