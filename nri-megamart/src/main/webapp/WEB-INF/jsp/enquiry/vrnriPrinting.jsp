...
<body>
<div class="modal fade" id="printenquiry" role="dialog">
            <div class="modal-dialog large_mdel">
                <!-- Modal content-->
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/vriPrinting" method="post" name="printenquiry">
						<button type="button" class="close popup_close" data-dismiss="modal">
							<img src="images/close.png">
						</button>									
						<div class="modal-body large_mdel_body">
                            <p class="popup_heading general_padding">Print VR NRI Enquiry</p>						
							<div class="row">					    
										...
										<div class="col-xs-12 col-sm-6">
											...
											<p>Enquiry</p>
												<select name="type" class="courier_enquiry" onchange="gender(this);">
													...
													<option>One Time Print Order</option>
										...
										<div class="col-xs-12 col-sm-4 ">
											<div class="general_inche">
												<div class="spec_instruc">
													...
													<textarea name="companyName" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>
										<div class="col-xs-12 col-sm-4">
							...
							<pre id="printenquiry_result"></pre>
					</form>					
		        </div>
		    </div>
		</div>
