...
<body>
<div class="modal fade" id="localtourenquiry" role="dialog">
            <div class="modal-dialog large_mdel">
                <!-- Modal content-->
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/tour" method="post" name="localtourenquiry">
						<button type="button" class="close popup_close" data-dismiss="modal">
							<img src="images/close.png">
						</button>							
						<div class="modal-body large_mdel_body">
                            <p class="popup_heading general_padding">Local Tour Packages Enquiry</p>						
							<div class="row">					    
							...
							<pre id="localtourenquiry_result"></pre>
					</form>					
		        </div>
		    </div>
		</div>		
