...
<body>
<div class="modal fade" id="serviceenquiry" role="dialog">
            <div class="modal-dialog large_mdel">
                <!-- Modal content-->
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/itServices" method="post" name="serviceenquiry">
						<button type="button" class="close popup_close" data-dismiss="modal">
							<img src="images/close.png">
						</button>							
						<div class="modal-body large_mdel_body">
                            <p class="popup_heading general_padding">IT Series Enquiry</p>						
							<div class="row">					    
								<div class="col-xs-12 col-sm-8" style="margin-top:3px;">
                                        ...
                                        <div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													...
													<textarea name="naturOfBiz" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>																													
									</div>
									<div class="tailor_group tailor_padding">									
										<div class="col-xs-12 col-sm-6">
											<div class="general_inche">
											<p>Requirement</p>
												<select name="reqType" class="courier_enquiry" onchange="gender(this);">
													<option>Requirement Type</option>
													<option>New Projrct</option>
													<option>Improvement To</option>
												</select>
											</div>
										</div>																				
									</div>
									<div class="tailor_group tailor_padding">
									    <div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													<span>About Organisation</span>
													<textarea name="about" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>
                                        <div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													...
													<textarea name="budget" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>																													
									</div>
									...
									<div class="tailor_group tailor_padding">
										<div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													<span>Descriptions Of The Requirement</span>
													<textarea name="desc" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>
	                                    <div class="col-xs-12 col-sm-6">
											<div class="general_inche">
											<p>Business</p>
												<select name="location" class="courier_enquiry" onchange="gender(this);">
							...
							<pre id="serviceenquiry_result"></pre>
					</form>					
		        </div>
		    </div>
		</div>
