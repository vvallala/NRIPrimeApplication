	...
	<div class="modal fade" id="generalenquiry" role="dialog">
		<div class="modal-dialog large_mdel">
			...
			<div class="modal-content large_mdel_cntent">
				<form action="/nriprime/enquiry/general" method="post" name="general">
								...
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6">
										<div class="tailor_group ">
											<p>Priority</p>
											<select name="priority" class="courier_enquiry" onchange="gender(this);">
												<option></option>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="tailor_group ">
											<div class="spec_instruc">
												...
												<textarea name="typesOfHelp" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
								</div>
