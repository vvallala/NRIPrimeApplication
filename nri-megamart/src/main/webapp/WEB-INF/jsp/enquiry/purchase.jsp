...
<body>
<div class="modal fade" id="purchaseenquiry" role="dialog">
            <div class="modal-dialog large_mdel">
                <!-- Modal content-->
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/purchase" method="post" name="purchaseenquiry">
						<button type="button" class="close popup_close" data-dismiss="modal">
							<img src="images/close.png">
						</button>						
						<div class="modal-body large_mdel_body">
                            <p class="popup_heading general_padding">Purchase Enquiry</p>						
							<div class="row">					    
								<div class="col-xs-12 col-sm-8" style="margin-top:3px;">
									<div class="tailor_group tailor_padding">										
										<div class="col-xs-12 col-sm-6">
											...
											<p>Category</p>
												<select name="category" class="courier_enquiry" onchange="gender(this);">
													<option></option>
													<option>List Of All Products</option>
													<option></option>
												</select>
											</div>
										</div> 
										<div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												...
												<input name="deliveryDate" value="31-05-2018" class="cart_date_pick" type="date">
											</div>
										</div>										
									</div>
									<div class="women_tailor_form">
									<p class="page_upload" style="margin-top: -5px;margin-bottom: 5px;">Please Select Example Images</p>
										<div class="tailor_group contest_upload margin_content">	                                                											
											<div class="col-xs-12 col-sm-12 ">											
												<input name="pic" id="auto" type="file" /><output id="mobile" />
											</div>
										</div>
								    </div>
									<div class="tailor_group tailor_padding">
										...
										<div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													...
													<textarea name="details" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>
	                                    <div class="col-xs-12 col-sm-6">
							...
							<pre id="purchaseenquiry_result"></pre>
					</form>					
		        </div>
		    </div>
		</div>
