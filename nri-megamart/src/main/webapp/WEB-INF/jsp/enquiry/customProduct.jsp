...
<body>
<div class="modal fade" id="customenquiry" role="dialog">
            <div class="modal-dialog large_mdel">
                <!-- Modal content-->
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/customProduct" method="post" name="customenquiry">
						<button type="button" class="close popup_close" data-dismiss="modal">
							<img src="images/close.png">
						</button>							
						<div class="modal-body large_mdel_body">
                            <p class="popup_heading general_padding">Custom Product Enquiry</p>						
							<div class="row">					    
								<div class="col-xs-12 col-sm-8" style="margin-top:3px;">
										...
										<div class="col-xs-12 col-sm-6">
											<div class="general_inche">
												<div class="spec_instruc">
													...
													<textarea name="productName" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>
										<div class="col-xs-12 col-sm-6 ">
                                    ...
                                    <div class="tailor_group tailor_padding">
										<div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													<span>Detials Of The Product</span>
							...
							<pre id="customenquiry_result"></pre>
					</form>					
		        </div>
		    </div>
		</div>
