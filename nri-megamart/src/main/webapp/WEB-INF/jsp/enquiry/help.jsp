									...
									<div class="tailor_group tailor_padding">										
                                       <div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<p>Arival Date</p>
												<input name="arrivalDate" value="31-05-2018" class="cart_date_pick" type="date">
											</div>
										</div>											
										<div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<p>Departure Date</p>
												<input name="departureDate" value="31-05-2018" class="cart_date_pick" type="date">
											</div>
										</div>										
									</div>
									<div class="tailor_group tailor_padding">										
                                        <div class="col-xs-12 col-sm-6">
											<div class="general_inche">
											<p>Stay Duration</p>
												<input name="stayDuration" class="form-control contact_prsn_name" type="text" placeholder="Stay Duration Hyd">
											</div>
										</div>										
									</div>
									<div class="tailor_group tailor_padding">
										...
										<div class="col-xs-12 col-sm-6 ">
											<div class="general_inche">
												<div class="spec_instruc">
													...
													<textarea name="typeOfHelp" class="form-control tailor_instruction"></textarea>
												</div>
											</div>
										</div>
	                                    <div class="col-xs-12 col-sm-6">
