...
<body>
	<div class="modal fade" id="realestateenquiry" role="dialog">
		<div class="modal-dialog large_mdel">
			<!-- Modal content-->
			<div class="modal-content large_mdel_cntent">
				<form action="/nriprime/enquiry/realEstate" method="post" name="realestateenquiry">
					<button type="button" class="close popup_close"
						data-dismiss="modal">
						<img src="images/close.png">
					</button>
					<div class="modal-body large_mdel_body">
						<p class="popup_heading general_padding">Real Estat Enquiry</p>
						<div class="row">
							<div class="col-xs-12 col-sm-8" style="margin-top: 3px;">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<div class="spec_instruc">
												<span>Purpose To Buy Property</span>
												<textarea name="purpose" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
								</div>
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<div class="spec_instruc">
												<span>Bhk/Sqft</span>
												<textarea name="bhkOrSft" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
								...
								<div class="tailor_group tailor_padding">
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<p>Funds</p>
											<select name="paymentType" class="courier_enquiry" onchange="gender(this);">
												<option>Mode Of Funding</option>
												<option>Cash</option>
									...
									<div class="col-xs-12 col-sm-6">
										<div class="enquiry_contact">
											<div class="spec_instruc">
												...
												<textarea name="specificRequirement" class="form-control tailor_instruction"></textarea>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-sm-6">
