...
<body>
<div class="modal fade" id="taxationenquiry" role="dialog">
            <div class="modal-dialog large_mdel">
                <!-- Modal content-->
                <div class="modal-content large_mdel_cntent">
					<form action="/nriprime/enquiry/tax" method="post" name="taxationenquiry">
						<button type="button" class="close popup_close" data-dismiss="modal">
							<img src="images/close.png">
						</button>							
						<div class="modal-body large_mdel_body">
                            <p class="popup_heading general_padding">US Taxation Enquiry</p>						
							<div class="row">					    
								<div class="col-xs-12 col-sm-8" style="margin-top:3px;">
									<div class="tailor_group tailor_padding">
										<div class="col-xs-12 col-sm-4 ">
											<div class="general_inche">
												<select name="type" class="courier_enquiry" onchange="gender(this);">
													<option>Type Of Tax</option>
												</select>
											</div>
										</div>
										<div class="col-xs-12 col-sm-4">
											<div class="general_inche">
												<select name="country" class="courier_enquiry" onchange="gender(this);">
										...
										<div class="col-xs-12 col-sm-4">
											<div class="general_inche">
												<select name="city" class="courier_enquiry" onchange="gender(this);">
													<option>City</option>
												</select>
											</div>
										</div>
									...
									<div class="tailor_group tailor_padding">										
										<div class="col-xs-12 col-sm-12">
                                            ...
                                            <span class="sign-radio del-radio form_buttons"> Single</span></br>
											<input name="womenGarmentPadding" type="radio">
                                            <span class="sign-radio del-radio form_buttons"> Married Filing Jointly(Even If Only One Had Income)</span></br>
											<input name="womenGarmentPadding" type="radio">
                                            <span class="sign-radio del-radio form_buttons"> Married Filing Separately</span></br>
											<input name="womenGarmentPadding" type="radio">
                                            <span class="sign-radio del-radio form_buttons"> Head Of Household(With Qualifying)</span></br>
											<input name="womenGarmentPadding" type="radio">
                                            <span class="sign-radio del-radio form_buttons"> Qualifying Widow With Dependent Child</span></br>
