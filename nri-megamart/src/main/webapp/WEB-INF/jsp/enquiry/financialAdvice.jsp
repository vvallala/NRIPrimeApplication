...
<body>
	<div class="modal fade" id="financialenquiry" role="dialog">
		<div class="modal-dialog large_mdel">
			<!-- Modal content-->
			<div class="modal-content large_mdel_cntent">
				<form action="/nriprime/enquiry/financialAdvice" method="post" name="financialenquiry">
					<button type="button" class="close popup_close"
						data-dismiss="modal">
						<img src="images/close.png">
					</button>
					<div class="modal-body large_mdel_body">
						<p class="popup_heading general_padding">Financial Advice In
							India Enquiry</p>
						<div class="row">
							<div class="col-xs-12 col-sm-8" style="margin-top: 3px;">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<select name="type" class="courier_enquiry" onchange="gender(this);">
												<option>Tppe Of Investment</option>
												<option>Exisiting Investment</option>
								...
								<div class="tailor_group tailor_padding">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="general_inche">
											<p>Preferred Contact Date And Time</p>
